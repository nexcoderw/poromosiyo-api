...
export class AdminAuthManagementController {
  constructor(
    ...
    private readonly localPassword: LocalPasswordService,
    private readonly authMethods: AuthMethodManagementService,
  ) {}
  ...
  async logoutAll(
    ...
    await this.sessions.logoutAll(user);
  }
  ...
  methods(
    ...
    return this.authMethods.getMethods(user);
  }
  ...
  async setPassword(
    ...
    await this.localPassword.setPassword(
      user,
      dto.newPassword,
      dto.confirmPassword,
    );
  ...
  async unlinkGoogle(
    ...
    await this.authMethods.unlinkGoogle(user, dto.currentPassword);
  }
}
