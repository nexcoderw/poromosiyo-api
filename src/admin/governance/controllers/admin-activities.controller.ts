...
import { ListGlobalActivitiesDto } from '../dto/list-global-activities.dto';
...
export class AdminActivitiesController {
  constructor(private readonly activities: AdminUserActivitiesService) {}
  ...
  list(
    ...
    return this.activities.listAll(query);
  }
}
