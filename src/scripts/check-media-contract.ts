...
const files = {
  ...
  categoriesDto:
    resolve(
      root,
      'src/admin/catalog/dto/category.dto.ts',
    ),

  brandsDto:
    resolve(
      root,
      'src/admin/catalog/dto/brand.dto.ts',
    ),
...
console.log(
  'Poromosiyo Milestone 20 media contract verification successful.',
);
