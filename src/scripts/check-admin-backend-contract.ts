...
const files = {
  ...
  roleUtil:
    resolve(
      root,
      'src/auth/auth-role.util.ts',
    ),

  roleGuard:
    resolve(
      root,
      'src/auth/guards/auth-role.guard.ts',
    ),
  ...
  seed:
    resolve(
      root,
      'src/scripts/seed-superadmin.ts',
    ),
...
const catalog =
  read(files.catalogProducts);

assertIncludes(
  catalog,
  "@Patch('publication')",
  'product publication route',
);

const admins =
  read(files.adminController);
...
console.log(
  'Poromosiyo admin backend contract verification successful.',
);

console.log(
  'Verified ADMIN/SUPERADMIN role hierarchy.',
);

console.log(
  'Verified admin catalog module registration.',
);

console.log(
  'Verified admin governance module registration.',
);

console.log(
  'Verified dedicated product publication route.',
);

console.log(
  'Verified secure SUPERADMIN seed contract.',
);

console.log(
  'Verified Milestone 14 governance DB dependency.',
);
